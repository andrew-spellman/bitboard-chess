...
impl Move {
    fn new(initial_rank: u8, initial_file: u8, final_rank: u8, final_file: u8) {
        Self {
            initial_pos: Pos::new(initial_rank, initial_file),
            final_pos: Pos::new(final_rank, final_file),
        }
    }
}
